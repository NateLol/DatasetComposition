...
def vis_detections(im, im_name, class_name, dets, ax, thresh=0.5):
    ...
    with open('{}.xml'.format(im_name[0:-4]), 'w') as f:
        ...
        node_filepath = SubElement(node_root, 'filepath')
...
def parse_args():
    ...
    parser.add_argument('--model', dest='model', help='Model path',
                        default=' ')
    parser.add_argument('--im_name', dest='im_name', help='Path to folder single image', default='../data/demo')
...
if __name__ == '__main__':
    ...
    #im_name= '/home/jane/Desktop/dataset/images/3552.jpg'

    #for im_name in im_names:
    #    im_name = os.path.abspath(im_name)
    #    print('predicting for {:s}'.format(im_name))
    print('Runing faster rcnn on single image {:s}'.format(args.im_name))
